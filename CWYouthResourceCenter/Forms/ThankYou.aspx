<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ThankYou.aspx.vb" Inherits="CWYouthResourceCenter.ThankYou" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="playingField" class="col-md-13">
        <h2 class="centered" style="color:#3399FF;font-size:36px;">
            Thank You for your Contributions to the CW Youth Resource Center.
        </h2>
