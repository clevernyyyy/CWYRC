<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CancelDonation.aspx.vb" Inherits="CWYouthResourceCenter.CancelDonation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="playingField" class="col-md-13">
        ...
        <p>Please reconsider your contribution to the CW Youth Resource Center.  We need your help!</p>
